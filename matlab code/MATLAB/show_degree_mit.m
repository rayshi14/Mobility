function show_degree_mit()
scanning_interval = 300; % scanning interval = 300 seconds
base_input_filename = 'contacts_mit_';
output_filename = 'degree_mit';
num_nodes = 50;
degrees = zeros(num_nodes, 2);
for id = 5:num_nodes % # of nodes is 20
    if id ~= 25 && id ~= 48
        ...
        current_time = 1094740000; % time index of the simulation, will increase till the end of the list
        degree_count = 0;
