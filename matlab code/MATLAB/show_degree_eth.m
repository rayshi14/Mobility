function show_degree_eth()
scanning_interval = 120; % scanning interval = 300 seconds
base_input_filename = 'contacts_eth_';
output_filename = 'degree_eth';
num_nodes = 20;
...
for id = 1:num_nodes % # of nodes is 20
    ...
    current_time = 380000; % time index of the simulation, will increase till the end of the list
    degree_count = 0;
