function [out_x_coord1, out_x_coord2, out_y_final1_eff, out_y_final2_eff] = process_new_method_eth_easy(in_size_states, in_e_samples, in_num_sim)

base_filename = 'variants_eth_';
% controlled var
size_actions = 100;
