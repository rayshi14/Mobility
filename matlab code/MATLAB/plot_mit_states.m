...
in_size_states = 3;
[out_x_coord1, out_x_coord3, out_y_final1_eff, out_y_final3_eff] = process_new_method_mit_easy(in_size_states, in_e_samples, in_num_sim);
in_size_states = 4;
[out_x_coord1, out_x_coord4, out_y_final1_eff, out_y_final4_eff] = process_new_method_mit_easy(in_size_states, in_e_samples, in_num_sim);
